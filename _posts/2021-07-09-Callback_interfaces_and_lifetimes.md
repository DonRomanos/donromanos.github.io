...
I had my problem solved and left it for my problem with the pattern described so far. However my curiosiy had been awoken. Can we generalize this approach independent of the use case? And is there any point to it?

Lets try to find out.

What I mean by generalizing is separating the whole `Publisher-Subscriber` thing from the part of receiving the images. Since tracing the lifetime of an instance is a completely different problem than calling the correct callback.
